...
#
#
#   LEIA ARQUIVO readme, nele contem instrucoes para funcionamento
#   LEIA ARQUIVO readme, nele contem instrucoes para funcionamento
#   LEIA ARQUIVO readme, nele contem instrucoes para funcionamento
#
# game.py
...
class Game:
    ...
    def run( self ):
        ...
        #numAgents = len( self.agents ) #ekamoto

        #Congera os fantasmas heheh
        numAgents = 1
...
################################################################################################################
            ...
            self.muteAgents = True

            #ekamoto: nao sei porque mas nao funciona direito com isso
            #key = cv2.waitKey(1) & 0xFF

            # Movimento do pacman
            if (agentIndex == 0):
                direcao = self.joystick.predict(self.obj.thsv[0])

                if(direcao in self.state.getLegalActions(0)):
                    action = direcao
                #print action
